  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Hanuman Junction, AP</p>
            </div>
          </div>
          <div className="flex items-center gap-1 sm:gap-2">
            <Link href="/products" className="text-sm text-muted-foreground hover:text-amber-700 dark:hover:text-amber-400 transition-colors px-2">Products</Link>
            <Link href="/contact" className="text-sm text-muted-foreground hover:text-amber-700 dark:hover:text-amber-400 transition-colors px-2">Contact</Link>
            <ThemeToggle />
            <Link href="/login">
      ...
      <section className="relative bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 dark:from-amber-950/40 dark:via-orange-950/20 dark:to-amber-900/20 px-4 py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <p className="mt-5 text-base md:text-lg text-amber-800/80 dark:text-amber-300/90 max-w-lg mx-auto leading-relaxed">
            We sell broken rice, husk, and bran at wholesale rates — and we&apos;re actively procuring paddy from farmers and traders across Krishna & NTR districts.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-xs font-semibold px-3 py-1.5 rounded-full mb-4">
              <CheckCircle className="w-3.5 h-3.5" /> All Licences Active & Current
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">Licensed. Verified. Trusted.</h2>
            <p className="text-muted-foreground text-sm mt-2 max-w-md mx-auto">
              Panduranga Rice Mill holds 6 active government licences and registrations — so you always know you&apos;re dealing with a fully compliant, accountable business.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                We are actively procuring paddy from farmers and traders across Krishna & NTR districts. Skip the government queue — get fair rates, fast payment, and a direct relationship with the mill.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { title: "Fair Pricing", desc: "Rates at or above govt MSP. Ask us for today's rate.", icon: "💰" },
                { title: "Quick Payment", desc: "Same or next-day payment. No holding, no delays.", icon: "⚡" },
                { title: "All Varieties", desc: "BPT 5204, MTU 1010, Rajanna, and others accepted.", icon: "🌾" },
                { title: "Certified WeighBridge", desc: "Licensed & official — your weight is recorded accurately, always.", icon: "⚖️" },
              ].map((item) => (
      ...
      <footer className="bg-amber-950 dark:bg-black/80 text-amber-400 px-4 py-6 text-center text-sm">
        ...
        <p className="mt-1 text-amber-500">Hanuman Junction, Krishna District, Andhra Pradesh</p>
